...
/// Debug timer implementation with command-based stop/reset controls.
class FakeGameTimer implements GameTimer {
  ...
  /// Registers a debug command that forces timer completion.
  void _listenInputStop() {
    CommandRegistry.instance.register(
      'time',
      'reset and stop timer (simulate end of time)',
      (arg) async {
        stoped = true;
      },
    );
