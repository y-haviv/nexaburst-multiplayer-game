...
class FakeDrinkModel implements DrinkingGame {
  ...
  void _fakeStreamUpdate(bool toDrink) {
    ...
    if (toDrink &&
        !drinkPlayers.containsKey(FakeRoomData.currentPlayerDefault.id)) {
      drinkPlayers[FakeRoomData.currentPlayerDefault.id] =
          FakeRoomData.currentPlayerDefault.username;
    } else if (!toDrink &&
        drinkPlayers.containsKey(FakeRoomData.currentPlayerDefault.id)) {
